...
var PieWeightedScoringProcessor = function () {
  ...
  _createClass(PieWeightedScoringProcessor, [{
    key: "score",
    value: function score(sessions, outcomes) {
      var scoreableComponents = this._getScoreableComponents(sessions, outcomes);
    ...
    value: function _getScoreableComponents(sessions, outcomes) {
      var results = {};
      var pies = this._config.pies;
    ...
    value: function _getWeights(scoreableComponents) {
      var results = {};
      var weights = this._config.weights || [];
